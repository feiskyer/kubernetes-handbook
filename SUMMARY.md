...
- [4. 部署配置](deploy/index.md)
  ...
  - [4.6 Kubernetes-The-Hard-Way](deploy/kubernetes-the-hard-way.md)
    - [事先准备](deploy/docs/01-prerequisites.md)
    - [安装 Client 工具](deploy/docs/02-client-tools.md)
    - [准备计算资源](deploy/docs/03-compute-resources.md)
    - [提供 CA 和产生 TLS 凭证](deploy/docs/04-certificate-authority.md)
    - [配置和生成 Kubernetes 配置文件](deploy/docs/05-kubernetes-configuration-files.md)
    - [配置和生成密钥](deploy/docs/06-data-encryption-keys.md)
    - [启动 etcd 群集](deploy/docs/07-bootstrapping-etcd.md)
    - [启动 Kubernetes 控制节点](deploy/docs/08-bootstrapping-kubernetes-controllers.md)
    - [启动 Kubernetes Node 节点](deploy/docs/09-bootstrapping-kubernetes-workers.md)
    - [配置 Kubectl](deploy/docs/10-configuring-kubectl.md)
    - [配置 Pod 网络路由](deploy/docs/11-pod-network-routes.md)
    - [部署 DNS 扩展](deploy/docs/12-dns-addon.md)
    - [烟雾测试](deploy/docs/13-smoke-test.md)
    - [删除集群](deploy/docs/14-cleanup.md)
...
- [6. 应用管理](apps/index.md)
  ...
  - [Istio和Service Mesh](apps/istio.md)
