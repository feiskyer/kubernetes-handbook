...
- [3. 插件扩展](plugins/index.md)
  ...
  - [3.5 Network Policy](plugins/network-policy.md)
  - [3.6 Ingress Controller](plugins/ingress.md)
  ...
  - [3.7 Cloud Provider](plugins/cloud-provider.md)
  - [3.8 Scheduler扩展](plugins/scheduler.md)

## 实践案例

- [4. 应用管理](apps/index.md)
  - [4.1 滚动升级](apps/service-rolling-update.md)
  - [4.2 Helm](apps/helm-app.md)
    - [Helm参考](apps/helm.md)
  - [4.3 Operator](apps/operator.md)
  - [4.4 Deis workflow](apps/deis.md)
- [5. 实践案例](practice/index.md)
  - [5.1 部署配置](deploy/index.md)
  ...
  - [5.2 监控](monitor/index.md)
  - [5.3 日志](deploy/logging.md)
  - [5.4 高可用](practice/ha.md)
  - [5.5 调试](practice/debugging.md)
