...
- [4. 部署配置](deploy/index.md)
  ...
  - [4.3 Kubernetes-The-Hard-Way](deploy/kubernetes-the-hard-way.md)
    ...
    - [安装命令行工具](deploy/kubernetes-the-hard-way/02-client-tools.md)
    - [准备计算资源](deploy/kubernetes-the-hard-way/03-compute-resources.md)
    - [配置 CA 并创建 TLS 证书](deploy/kubernetes-the-hard-way/04-certificate-authority.md)
    ...
    - [部署 Kubernetes 控制平面](deploy/kubernetes-the-hard-way/08-bootstrapping-kubernetes-controllers.md)
    - [部署 Kubernetes Workers 节点](deploy/kubernetes-the-hard-way/09-bootstrapping-kubernetes-workers.md)
