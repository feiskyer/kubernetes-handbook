...
- [2. 核心原理](architecture/index.md)
  ...
  - [2.2 主要概念](architecture/objects.md)
    ...
    - [ConfigMap](architecture/configmap.md)
...
- [6. 应用管理](apps/index.md)
  - [6.1 滚动升级](apps/service-rolling-update.md)
  - [6.2 Helm](apps/helm-app.md)
    - [Helm参考](apps/helm.md)
...
- [8. 开发指南](devel/index.md)
  - [8.1 开发环境搭建](devel/index.md)
  - [8.2 单元测试和集成测试](devel/testing.md)
  - [8.3 社区贡献](devel/contribute.md)
