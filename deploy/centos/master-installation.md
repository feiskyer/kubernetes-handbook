...
pem和token.csv证书文件我们在[TLS证书和秘钥](create-tls-and-secret-key.md)这一步中已经创建过了。我们再检查一下。
...
完整 unit 见 [kube-apiserver.service](https://github.com/feiskyer/kubernetes-handbook/tree/master/manifests/kube-apiserver.service)
...
完整 unit 见 [kube-controller-manager.service](https://github.com/feiskyer/kubernetes-handbook/tree/master/manifests/kube-controller-manager.service)
...
完整 unit 见 [kube-scheduler.service](https://github.com/feiskyer/kubernetes-handbook/tree/master/manifests/kube-scheduler.service)
