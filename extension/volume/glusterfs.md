...
我们直接在物理机上使用 yum 安装，如果你选择在 kubernetes 上安装，请参考 [https://github.com/gluster/gluster-kubernetes/blob/master/docs/setup-guide.md](https://github.com/gluster/gluster-kubernetes/blob/master/docs/setup-guide.md)。
...
官方的文档见[https://github.com/kubernetes/examples/tree/master/staging/volumes/glusterfs](https://github.com/kubernetes/examples/tree/master/staging/volumes/glusterfs).
