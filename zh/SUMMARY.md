...
- [7. 插件扩展](plugins/index.md)
  - [7.1 访问控制](plugins/auth.md)
    - [RBAC 授权](plugins/rbac.md)
    - [准入控制](plugins/admission.md)
  - [7.2 网络插件](network/index.md)
  ...
  - [7.3 Volume 插件](plugins/volume.md)
    - [glusterfs](plugins/glusterfs.md)
  - [7.4 Container Runtime Interface](plugins/CRI.md)
  - [7.5 Network Policy](plugins/network-policy.md)
  - [7.6 Ingress Controller](plugins/ingress.md)
  ...
  - [7.7 Cloud Provider](plugins/cloud-provider.md)
  - [7.8 Scheduler 扩展](plugins/scheduler.md)
  - [7.9 Device 插件](plugins/device.md)

## 服务治理

- [8. 服务治理](apps/index.md)
  - [8.1 一般准则](apps/patterns.md)
  - [8.2 滚动升级](apps/service-rolling-update.md)
  - [8.3 Helm](apps/helm-app.md)
    - [Helm 参考](apps/helm.md)
    - [Helm 原理](apps/helm-basic.md)
  - [8.4 Service Mesh](apps/service-mesh.md)
    - [Istio](apps/istio.md)
    - [Linkerd](apps/linkerd.md)
  - [8.5 Draft](apps/draft.md)
  - [8.6 Operator](apps/operator.md)
  - [8.7 Kompose](apps/kompose.md)
  - [8.8 Deis workflow](apps/deis.md)
  - [8.9 CI/CD](apps/cicd.md)
    - [Jenkins X](apps/jenkinsx.md)
    - [Spinnaker](apps/spinnaker.md)

## 实践案例

- [9. 实践案例](practice/index.md)
  - [高可用](practice/ha.md)
...
- [10. 大数据与机器学习](machine-learning/index.md)
  - [Spark](machine-learning/spark.md)
  - [Tensorflow](machine-learning/tensorflow.md)
- [11. Serverless](serverless/index.md)
- [12. 排错指南](troubleshooting/index.md)
